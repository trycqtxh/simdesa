<div class="modal" id="modal-tambah-sub-bidang" data-backdrop="static" data-keyboard="false">
...
<div class="modal" id="modal-ubah-sub-bidang" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal" id="modal-tambah-pendapatan" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form class="form-horizontal" role="form">
                <div class="modal-body">
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="uraian" id="uraian">
                            <input type="hidden" name="sub_pendapatan">
                            <input type="hidden" name="jenis">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
...
<div class="modal" id="modal-ubah-pendapatan" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
