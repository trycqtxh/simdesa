            ...
            <form class="form-horizontal" role="form">
                <div class="modal-body">
                    <div class="form-group form-group-sm">
                        <label for="tanggal_pengiriman" class="col-md-4 control-label">Tanggal Pengiriman</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group form-group-sm">
                        <label for="ditujukan_kepada" class="col-md-4 control-label">Di Tujukan Kepada</label>
                        <div class="col-md-8">
                            <input class="form-control" name="ditujukan_kepada" id="ditujukan_kepada" tabindex="4">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label for="isi_surat" class="col-md-4 control-label">Isi Surat Dikirim</label>
                        <div class="col-md-8">
