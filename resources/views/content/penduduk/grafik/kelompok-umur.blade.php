...
@section('title', 'Grafik Penduduk Berdasarkan Umur')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-umur"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var umur = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-umur",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($umur['grafik']) !!}
