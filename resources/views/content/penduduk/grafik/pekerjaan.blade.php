...
@section('title', 'Grafik Penduduk Bedasarkan Pekerjaan')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-pekerjaan"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var pekerjaan = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-pekerjaan",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($pekerjaan['grafik']) !!}
