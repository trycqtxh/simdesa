...
@section('title', 'Grafik Penduduk Berdasarkan Pendidikan')
...
@section('content-main')
    <div class="box box-default">
        ...
        <div id="chart-penduduk-pendidikan"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var pendidikan = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-pendidikan",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($pendidikan['grafik']) !!}
