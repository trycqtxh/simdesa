...
@section('title', 'Grafik Penduduk Berdasarkan Agama')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-agama"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var agama = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-agama",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($agama['grafik']) !!}
