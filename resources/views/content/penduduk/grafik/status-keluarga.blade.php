...
@section('title', 'Grafik Penduduk Berdasarkan Status Kaluarga')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-keluarga"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var keluarga = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-keluarga",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($keluarga['grafik']) !!}
