...
@section('title', 'Grafik Penduduk Berdasarkan Status Perkawinan')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-kawin"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var kawin = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-kawin",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($kawin['grafik']) !!}
