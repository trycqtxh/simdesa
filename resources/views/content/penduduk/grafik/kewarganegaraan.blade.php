...
@section('title', 'Grafik Penduduk Berdasarkan Kewarganegaraan')
...
@section('content-main')
    <div class="box box-default">
        <div class="box-body">
            ...
            <div id="chart-penduduk-warga"></div>
...
<script type="text/javascript">
    FusionCharts.ready(function () {
        ...
        var warga = new FusionCharts({
            "type": "pie3d",
            "renderAt": "chart-penduduk-warga",
            "width": "100%",
            "height": "300",
            "dataFormat": "json",
            "dataSource": {!! json_encode($warga['grafik']) !!}
