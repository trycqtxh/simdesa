...
<div class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12 text-center well" id="template-surat" style="height: inherit; padding-left: 160px; padding-right: 160px">
        ...
        <p>Adalah salah satu warga Kami yang memohon Surat Keterangan Kehilangan <div class="form-group form-group-sm"><input class="form-control" name="tujuan" ></div> </p>
        <p>Demikian surat keterangan ini kami buat dengan sebenarnya untuk dipergunakan bahan selanjutnya.</p>
