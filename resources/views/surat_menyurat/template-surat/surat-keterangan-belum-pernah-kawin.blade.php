...
<div class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12 text-center well" id="template-surat" style="height: inherit; padding-left: 160px; padding-right: 160px">
        ...
        <br>
        <br>
        <p>Yang bertanda tangan di bawah ini Kepala {{ $profil->find('des')['value'].' '.$profil->find('desa')['value'] }} Kecamatan {{ $profil->find('kecamatan')['value'] }} Pemerintah Daerah {{ $profil->find('kab')['value'].' '.$profil->find('kota')['value'] }},  menerangkan dengan sesungguhnya, bahwa :</p>
        ...
        <table id="surat" style="font-size:12pt; text-align: left; font-family: 'Times New Roman'" align="center" width="90%">
            ...
            <tr>
                ...
                <td>Bin/Binti</td>
                <td>:</td>
                <td><div class="form-group form-group-sm"><input class="form-control" name="bin_binti"></div></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>Jenis Kelamin</td>
        ...
        <p>Orang tersebut di atas menurut penelitian serta data yang ada pada kami belum pernah menikah.</p>
