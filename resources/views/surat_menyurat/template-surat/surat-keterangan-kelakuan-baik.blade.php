...
<div class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12 text-center well" id="template-surat" style="height: inherit; padding-left: 160px; padding-right: 160px">
        <h3><u>SURAT KETERANGAN KELAKUAN BAIK</u></h3>
        ...
        <br>
        <br>
        <p>Yang bertanda tangan di bawah ini Kepala {{ $profil->find('des')['value'].' '.$profil->find('nama_desa')['value'].' '.
        $profil->find('kec')['value'].' '.$profil->find('kecamatan')['value'].' Pemerintah Daerah '.$profil->find('kab')['value'].' '.$profil->find('kota')['value'] }},  menerangkan dengan sesungguhnya, bahwa :</p>
        ...
        <table id="surat" style="font-size:12pt; text-align: left; font-family: 'Times New Roman'" align="center" width="90%">
            ...
            <tr>
                ...
                <td style="width:1%">:</td>
                <td style="width:69%"><div class="form-group form-group-sm"><input class="form-control" name="tempat_tanggal_lahir"></div></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>Pekerjaan</td>
        ...
        <p>Orang tersebut di atas menurut penelitian kami selama di {{ $profil->find('des')['value'].' '.$profil->find('nama_desa')['value'] }} berkelakuan baik, belum pernah tersangkut urusan dengan kepolisian.</p>
        <p>Surat keterangan ini diperlukan dalam rangka <div class="form-group form-group-sm"><input class="form-control" name="tujuan" ></div> </p>
